...
<!-- Prepended checkbox -->
  ...
  <div class="col-md-4">
      <div class="input-group">
        <input id="specialInput" name="specialInput" class="form-control" type="checkbox" placeholder="Yes" value="Yes">Yes
      </div>
...
<script type="text/javascript">
    ...
    function postToGoogle() {
            ...
            statusCode: {
                0: function() { 
                  $.redirect('complete.php', {id: idInput, school: schoolInput, special: specialInput});
                },
                200: function() {
                }
            }
    ...
    $('#divConcern4').toggle();
        ...
        <footer>
            <div class="container section">
                ...
                <a href="suggest.html"><button>Suggestion Box</button></a>
