...
<div id="procedure" class="section wrap">
    ...
    <!--div class="panel">
        ...
        <div class="description">
            <h3>Advisement</h3>
            <p>
               Advisement is done for those who wish to fix their IPS. <br>
    <div class="questioncontain">
        <div>
            <div class="question flow">
                <a onclick="toggle_visibility('one');"><button>What is an IPS?</button></a>
                <div id="one">
                    IPS or Individual Program of Study is akjdsfls 
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        ...
        <div class="description">
            <h3>Release of Batch Schedule</h3>
            <p>
                Check your OBF Email account for your Batch Schedule or through the <a href="batch.php">Manual Registration System</a><br>
                Please note that your ONLINE ENLISTMENT Batch Number is different from your MANUAL REGISTRATION Batch Number<br>
                For concerns regarding Batch Scheduling contact <a href="https://www.facebook.com/RegComHelpdesk/">Regcom's Helpdesk</a> <br>
                *Note: Batch numbers are generated by The Office of Management Information Systems<br>
                </ul> <br>
            </p>
        </div>
        <div style="clear:both;"></div>
        ...
        <div class="description">
            ...
            <p>
                ...
                <ul>Date:
                    ...
                    <li class = "indent"><?php echo $datefreshmenonline ?> - Freshmen and Transferees</li>
    ...
    <div class="panel">
        ...
        <div class="description">
            ...
            <p>
                <srtong>ONLY STUDENTS WITH ENLISTMENT PROBLEMS SHOULD GO TO MANUAL REGISTRATION </strong><br>
                ...
                <ul>Dates:
                    ...
                    Time: <?php echo $sathours ?><br-->
                     <li class = "indent"><?php echo $datefreshmanreg ?> - Freshmen and Transferees</li>
                ...
                Come during your <a href="batch.php">MANUAL REGISTRATION batch schedule</a>
                <ul>Venue:
    ...
    <div class="panel">
        ...
        <div class="description">
            ...
            <p>
                ...
                For printing of assessment forms only, please proceed to <?php echo $assessmentvenue ?>
            </p>
        </div>
        <div style="clear:both;"></div>
    </div>
